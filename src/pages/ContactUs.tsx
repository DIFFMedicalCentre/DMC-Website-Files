...
const ContactUs = () => {
  return (
    <>
      ...
      {/* Contact Form & Map */}
      <div className="flex flex-col lg:flex-row p-4 max-w-7xl mx-auto justify-center items-center gap-6">
        {/* Contact Form */}
        <div className="w-full lg:w-1/2 mx-auto p-6 bg-white shadow-lg rounded-lg">
        ...
        {/* Google Map */}
        <div className="shadow-lg rounded-lg w-full lg:w-1/2 p-4">
          <h1 className="text-3xl font-bold mb-6 text-center text-red-500 flex items-center justify-center gap-2">
            Locate Us - On Map
            <SiGooglemaps />
          </h1>
          ...
          <iframe
            title="DIFF Medical Centre Location"
            ...
            allowFullScreen
            loading="lazy"
            src="https://maps.google.com/maps?width=100%25&height=600&hl=en&q=No.%2010%20DIFF%20Road,%20Off%20Oladipo%20Diya%20Road,%20Gudu%20District%20Abuja%20(DIFF%20Medical%20Centre)&t=&z=14&ie=UTF8&iwloc=B&output=embed"
          ></iframe>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row gap-12 justify-center items-center text-center max-w-5xl w-full px-6 sm:px-12">
          ...
          <div className="md:w-1/2 flex flex-col items-center text-lg text-blue-600">
            ...
            <a
              ...
              className="py-2 px-4 bg-blue-950 text-white font-semibold rounded-lg focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition hover:bg-blue-900"
            >
              Give Us a Feedback
            </a>
          </div>
      ...
      {/* Working Hours */}
      <section className="w-full bg-gradient-to-r from-blue-100 to-blue-300 p-10">
        <div className="container mx-auto max-w-5xl text-center">
          ...
          <p className="text-lg text-gray-700 md:text-xl mb-4">
            Book an Appointment Today!
          </p>

          <Link
            to="/Appointment"
            className="inline-block bg-blue-950 text-white px-6 py-3 rounded-full font-semibold shadow-lg hover:bg-blue-900 transition-all duration-300 ease-in-out"
          >
